...
func (s *Service) GetArtifactByID(ctx context.Context, id, userID uuid.UUID) (*entities.Artifact, error) {
...
func (s *Service) DeleteArtifact(ctx context.Context, id, userID uuid.UUID) error {
